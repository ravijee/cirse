...
public class MainSceneComponent extends BranchGroup {
     ...
     * @see org.itver.graphics.util.ComponentType
     */
    public MainSceneComponent(ComponentType type, File source){
        this();
        this.type = type;
        this.source = source;
    }
     ...
     */
    private void updatePosition(double xpos, double ypos, double zpos) {
        setXPosition(xpos);
        setYPosition(ypos);
        setZPosition(zpos);
    ...
    public Point3d getRotation() {
        Point3d rot = new Point3d(rotation);
        return rot;
    }
    ...
    public void setRotation(double[] rotation) {
        ...
        pcs.firePropertyChange("Rotation", old, rotation);
     ...
     */
    private void setRotationTransform(){
...
//        t3d.setTranslation(new Vector3d(position));
    ...
    */
    ...
    //Pablo
    /**
     * Obtiene el contenido de este objeto. El contenido son aquellos modelos 
     * creados por plugins que se deseen añadir en el Entorno.
     * @return Contenido relacionado con este componente.
     */
    public BranchGroup getContent(){
        return this.content;
    }
    ...
    private void addCollisionBehavior(){
        //Pablo: Quite el oyente de las colisiones porque por ahora me estaba generando
        //excepciones. Por ahora NO hay deteccion de colisiones dentro del Entorno.
...
//        this.addChild(collidable);
    ...
    //Pablo
    /**
     * Relaciona el contenido generado por un plugin con este componente. 
     * Reemplazando el contenido anterior. Los objetos picable y furniture no se
     * relacionan con este metodo ni con {@link #getContent() getcontent()}.
     * @param content 
     */
    public void setContent(BranchGroup content){
        ...
        this.transformGroup.addChild(this.content);
    }
