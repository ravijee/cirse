...
//        setIcon(ImageUtilities.loadImage(ICON_PATH, true));
    ...
    public void propertyChange(PropertyChangeEvent evt) {
        /*
         * Agregué el if porque sin el los nodos se actualizaban en cualquier momento.
         * Haciendolo inusable. 
         */
        if(!(evt.getPropertyName().equalsIgnoreCase("selected")))
            this.navigator.setRootContext(new MainSceneNode(MainScene.getInstance()));
//        else if(evt.getSource() instanceof MainSceneComponent)
//            this.setSelectedCircle((MainSceneComponent)evt.getSource());
    }
