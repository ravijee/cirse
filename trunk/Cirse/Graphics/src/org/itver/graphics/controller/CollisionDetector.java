    ...
    public void processStimulus(Enumeration criteria) {
        while(criteria.hasMoreElements()){
            ...
            if (theCriterion instanceof WakeupOnCollisionEntry) {
                ...
                System.out.println(this.collidingObject + " Collided with " + theLeaf.getUserData());
                this.checkForLimitCollision(theLeaf);
            } else if (theCriterion instanceof WakeupOnCollisionExit) {
                Node theLeaf = ((WakeupOnCollisionExit) theCriterion).getTriggeringPath().getObject();
                System.out.println(this.collidingObject + " Stopped colliding with  " + theLeaf.getUserData());
            } else {
                Node theLeaf = ((WakeupOnCollisionMovement) theCriterion).getTriggeringPath().getObject();
                System.out.println(this.collidingObject + " Moved whilst colliding with " + theLeaf.getUserData());
                this.checkForLimitCollision(theLeaf);
            }
        }
        wakeupOn(oredCriteria);
